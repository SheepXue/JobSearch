...
// write: statement.executeUpdate
// read: ResultSet rs = statement.executeQuery();
//            if(rs.next())
public class MySQLConnection {
    ...
    public void unsetFavorateItems(String userId, String itemId) {
        if (conn == null) {
            System.err.println("DB connection failed");
            return;
        }
    ...
    public Set<String> getFavoriteItemIds(String userId) {
        ...
        try {
            ...
            PreparedStatement statement = conn.prepareStatement(sql);
            statement.setString(1, userId);
            // ResultSet? read operation in the database
    ...
    public boolean addUser(String userId, String password, String firstname, String lastname) {
        ...
        try {
            ...
            // here is different! how many row influenced

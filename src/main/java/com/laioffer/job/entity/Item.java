...
// sometimes the field in input may more than Item's field will give error
@JsonIgnoreProperties(ignoreUnknown = true)

// jackson will fill null automatically
...
public class Item {
    ...
    private Set<String> keywords;  // come from other ways

    @JsonProperty("id")      // field is private: JsonProperty must be add before the getter
                            // field is public: add JsonProperty if input json name is different
    public String getId() {
        return id;
    }
    @JsonProperty("title")
    ...
    // inner class first write a builder class
